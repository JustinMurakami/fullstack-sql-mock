...
const insertMockData = function() {
  ...
  products.forEach((product) => {
    var queryString = `INSERT INTO products (item, min_cost, curr_bid, ends_in, image) VALUES ('${product.item}', ${product.min_cost}, ${product.curr_bid}, ${product.ends_in}, '${product.image}');`
